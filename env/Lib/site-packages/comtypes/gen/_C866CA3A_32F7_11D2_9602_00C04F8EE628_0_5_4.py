...
__all__ = [
    'SpeechEmulationCompareFlags', 'DISPID_SAFGetWaveFormatEx',
    'ISpeechRecoResultDispatch', 'DISPID_SMSALineId',
    'SSTTTextBuffer', 'eLEXTYPE_RESERVED6', 'DISPID_SLPSymbolic',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SGRSTsItem',
    'SDTDisplayText', 'DISPID_SpeechVoice', 'SpObjectToken',
    'DISPID_SPRText', 'DISPID_SpeechVoiceEvent',
    'DISPID_SRRAlternates', 'SpObjectTokenCategory', 'SVSFParseSapi',
    'SVP_21', 'DISPID_SRGCmdLoadFromObject', 'DISPID_SPIRule',
    'SPGS_EXCLUSIVE', 'DISPID_SpeechLexiconPronunciation',
    'SPEI_RECO_STATE_CHANGE', 'eLEXTYPE_PRIVATE11',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SPRsItem',
    'SAFTADPCM_11kHzMono', 'SVP_13', 'ISpEventSource',
    'SAFT12kHz8BitMono', 'DISPID_SGRsDynamic',
    'SPEI_SENTENCE_BOUNDARY', 'SP_VISEME_6', 'SDTAlternates',
    'DISPID_SPPBRestorePhraseFromMemory', '_ISpeechRecoContextEvents',
    'ISpeechPhraseReplacements', 'SFTSREngine',
    'DISPID_SRCEPhraseStart', 'SGSExclusive',
    'DISPID_SRCERecognizerStateChange', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SDKSetBinaryValue', 'DISPID_SRRecognizer',
    'DISPID_SPEActualConfidence', 'SpeechRecognizerState',
    'SPSHT_EMAIL', 'ISpeechObjectToken', 'SAFTGSM610_8kHzMono',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SPPsCount',
    'SAFT16kHz16BitMono', 'SRERecoOtherContext', 'DISPID_SBSWrite',
    'DISPID_SRGetFormat', 'DISPID_SPAs_NewEnum',
    'DISPID_SpeechCustomStream', 'DISPID_SRIsShared',
    'SDTReplacement', 'DISPID_SRRDiscardResultInfo', 'SPEI_RESERVED5',
    'DISPID_SASFreeBufferSpace', 'DISPID_SLWType', 'SDTAudio',
    'DISPID_SpeechPhoneConverter', 'SpeechAudioFormatGUIDText',
    'SpeechPropertyAdaptationOn', 'DISPID_SPEAudioStreamOffset',
    'ISpProperties', 'SpeechBookmarkOptions', 'SPAS_PAUSE',
    'SpeechVoiceEvents', 'STSF_FlagCreate', 'SP_VISEME_3',
    'DISPID_SVSVisemeId', 'SpMMAudioIn', 'DISPID_SRRSetTextFeedback',
    'DISPID_SpeechPhraseRules', 'SPXMLRESULTOPTIONS',
    'DISPID_SRCEStartStream', 'SpeechGrammarTagDictation',
    'SPWT_DISPLAY', 'SpeechPartOfSpeech', 'SRCS_Disabled',
    'DISPID_SGRSTText', 'ISpeechRecoResult', 'SPFM_CREATE_ALWAYS',
    'SREStreamEnd', 'SpeechVisemeFeature', 'ISpeechResourceLoader',
    'DISPID_SVEWord', 'DISPID_SPRDisplayAttributes', 'SVSFPersistXML',
    'Speech_Max_Pron_Length', 'SVP_17', 'SREInterference',
    'SPSERIALIZEDPHRASE', 'ISpGrammarBuilder',
    'SPEI_PROPERTY_STRING_CHANGE', 'SpeechVoiceCategoryTTSRate',
    'ISpeechRecoResult2', 'SASPause', 'SPPS_LMA', 'SVPNormal',
    'SPSFunction', 'SASRun', 'SVSFDefault', 'SVEAllEvents',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SRCERecognition',
    'DISPID_SOTDataKey', 'SPCT_COMMAND', 'Speech_Max_Word_Length',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SGRSTs_NewEnum',
    'SPGRAMMARSTATE', 'DISPID_SPPNumberOfElements', 'SWTDeleted',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SRAImport',
    'SpeechRecoProfileProperties', 'SPSSuppressWord',
    'DISPID_SLPPhoneIds', 'ISpObjectTokenCategory',
    'SpeechRuleAttributes', 'DISPID_SVEViseme', 'SpCompressedLexicon',
    'SPRECOGNIZERSTATUS', 'SPRS_ACTIVE_USER_DELIMITED', 'SP_VISEME_9',
    'DISPID_SOTDisplayUI', 'DISPID_SRGCommit', 'DISPID_SPRsCount',
    'DISPID_SpeechPhraseProperties', 'SGRSTTDictation',
    'SDTPronunciation', 'SpInProcRecoContext', 'DISPID_SDKCreateKey',
    'SP_VISEME_2', 'SRTReSent', 'DISPID_SWFEChannels',
    'DISPID_SFSOpen', 'SAFT11kHz16BitStereo', 'ISpRecoGrammar2',
    'SP_VISEME_0', 'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SpSharedRecognizer', 'SpeechStreamFileMode', 'SAFT48kHz8BitMono',
    'SPAUDIOBUFFERINFO', 'DISPID_SPRuleParent', 'SpeechVoicePriority',
    'DISPID_SRGCmdSetRuleState', 'SPEI_RESERVED2',
    'eLEXTYPE_PRIVATE6', 'SVP_10', 'tagSTATSTG', 'DISPID_SPACommit',
    'eLEXTYPE_PRIVATE19', 'DISPID_SPIAudioStreamPosition',
    'ISpNotifyTranslator', 'SpeechCategoryPhoneConverters', 'SVP_6',
    'SPCATEGORYTYPE', 'SDKLCurrentConfig', 'SP_VISEME_15',
    'DISPID_SVRate', 'DISPID_SWFEExtraData', 'DISPID_SRCESoundEnd',
    'eLEXTYPE_PRIVATE12', 'DISPID_SGRSTransitions',
    'SAFTCCITT_uLaw_44kHzMono', 'SPWT_LEXICAL', 'DISPID_SGRsCount',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SOTGetStorageFileName',
    'SAFTADPCM_22kHzMono', '_ISpeechVoiceEvents', 'DISPID_SRStatus',
    'SpPhoneticAlphabetConverter', 'DISPID_SOTId',
    'DISPID_SpeechPhraseRule', 'DISPID_SVAlertBoundary',
    'SpeechTokenKeyFiles', 'SPEI_RESERVED1', 'DISPID_SPPFirstElement',
    'SPWORDLIST', 'SVSFVoiceMask', 'DISPID_SLWsItem',
    'SpeechLoadOption', 'SAFT12kHz16BitStereo', 'SRESoundEnd',
    'SPEI_SR_PRIVATE', 'ISpRecoCategory', 'DISPID_SPISaveToMemory',
    'DISPID_SPEs_NewEnum', 'DISPID_SDKGetStringValue',
    'SAFT22kHz16BitMono', 'DISPID_SpeechFileStream', 'SPBO_NONE',
    'SP_VISEME_1', 'ISpeechGrammarRules', 'DISPID_SAVolume',
    'IInternetSecurityMgrSite', 'SPEI_TTS_PRIVATE',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SRGetPropertyString',
    'DISPID_SOTRemove', 'SRSActiveAlways',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SGSEnabled', 'eLEXTYPE_PRIVATE4',
    'SPBO_TIME_UNITS', 'DISPID_SGRSTPropertyName', 'DISPID_SASState',
    'SECFIgnoreCase', 'SAFTCCITT_ALaw_11kHzStereo', 'SGLexical',
    'SpeechRecoEvents', 'STSF_AppData', 'SRADynamic', 'ISpNotifySink',
    'DISPID_SPEPronunciation', 'SPEI_ADAPTATION', 'SITooLoud',
    'SPPS_Unknown', 'SPCT_SUB_DICTATION', 'SLODynamic',
    'DISPID_SpeechGrammarRules', 'ISpeechPhraseElement',
    'SPPS_NotOverriden', 'DISPID_SRCEventInterests', 'ISpRecognizer3',
    'SP_VISEME_14', 'SINoise', 'SPPS_Verb', 'SpStreamFormatConverter',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPEI_SR_AUDIO_LEVEL',
    'ISpeechLexicon', 'SREPropertyNumChange', 'DISPID_SLWLangId',
    'SAFTADPCM_22kHzStereo', 'DISPID_SLPType', 'SAFT24kHz16BitMono',
    'SPPS_RESERVED3', 'eWORDTYPE_DELETED',
    'DISPID_SpeechLexiconProns', 'SPEI_WORD_BOUNDARY',
    'SAFT32kHz8BitStereo', 'DISPID_SABufferNotifySize',
    'DISPID_SDKGetlongValue', 'STCLocalServer', 'LONG_PTR', 'SVP_3',
    'SVP_19', 'SPPARTOFSPEECH', 'DISPID_SPIGrammarId', 'SVEBookmark',
    'SPAUDIOOPTIONS', 'SpeechStreamSeekPositionType',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'SpeechTokenKeyAttributes', 'SGPronounciation', 'SPGS_ENABLED',
    'SAFT11kHz8BitStereo', 'SpeechTokenValueCLSID', 'SGDSInactive',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SPEDisplayAttributes',
    'DISPID_SPIAudioSizeTime', 'SpeechDisplayAttributes',
    'SAFT11kHz8BitMono', 'SPEI_MIN_SR', 'DISPIDSPTSI', 'SPEI_VISEME',
    'DISPID_SVEBookmark', 'SDTProperty', 'SPWF_INPUT',
    'ISpeechPhraseRule', 'SpeechTokenShellFolder', 'SPRECOSTATE',
    'SpeechRuleState', 'DISPID_SPRuleName', 'SGDSActive',
    'SPSHORTCUTTYPE', 'eLEXTYPE_PRIVATE15', 'ISpRecoGrammar',
    'SRAExport', 'SVSFNLPMask', 'SPWORDPRONUNCIATIONLIST',
    'ISpShortcut', 'DISPID_SVESentenceBoundary',
    'DISPID_SRSAudioStatus', 'SP_VISEME_19', 'SpSharedRecoContext',
    'DISPID_SpeechLexiconWord', 'DISPID_SRSSupportedLanguages',
    'SPEI_MIN_TTS', 'DISPID_SRRSpeakAudio', 'DISPID_SAEventHandle',
    'SPWORDPRONUNCIATION', 'SpeechCategoryAppLexicons',
    'SPEI_START_SR_STREAM', 'SWTAdded', 'DISPID_SGRSTPropertyId',
    'SDKLDefaultLocation', 'SpVoice', 'DISPID_SDKDeleteKey',
    'SPPHRASE', 'SPCT_DICTATION', 'SpNotifyTranslator',
    'DISPID_SGRName', 'DISPID_SOTMatchesAttributes',
    'DISPID_SVEAudioLevel', 'DISPID_SVSInputWordPosition',
    'DISPID_SRCEPropertyNumberChange', 'SpStream',
    'SAFT32kHz8BitMono', 'DISPID_SRState', 'ISpeechVoice',
    'SPAR_High', 'DISPID_SRGSetWordSequenceData', 'SPFM_CREATE',
    'DISPID_SPAStartElementInResult', 'ISpeechPhraseElements',
    'DISPID_SPEsCount', 'SPRST_ACTIVE_ALWAYS', 'SPSEMANTICFORMAT',
    'ISpeechRecoContext', 'DISPID_SOTCreateInstance',
    'SDA_Two_Trailing_Spaces', 'SITooSlow', 'ISpStream',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SPRuleChildren', 'SRERecognition', 'DISPID_SRCResume',
    'SVP_0', 'SPSNoun', 'DISPID_SVSPhonemeId', 'ISpXMLRecoResult',
    'DISPID_SVGetProfiles', 'SRSInactiveWithPurge',
    'SAFT24kHz16BitStereo', 'SPSHORTCUTPAIR', 'SPWT_PRONUNCIATION',
    'ISpeechLexiconPronunciation', 'DISPID_SRCCreateGrammar',
    'SAFT44kHz16BitMono', 'DISPID_SBSSeek', 'SPAS_RUN', 'SPSLMA',
    'SPEI_VOICE_CHANGE', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SRGDictationSetState', 'DISPID_SPRNumberOfElements',
    'SPLOADOPTIONS', 'SVP_18', 'DISPID_SPRs_NewEnum',
    'DISPID_SPIProperties', 'SPPS_RESERVED2', 'SRESoundStart',
    'SPFM_NUM_MODES', 'SAFTGSM610_44kHzMono', 'SP_VISEME_17',
    'SRCS_Enabled', 'SPEI_SR_BOOKMARK',
    'ISpeechLexiconPronunciations', 'DISPID_SVSpeak',
    'DISPID_SVEStreamStart', 'SDTRule', 'DISPID_SDKSetStringValue',
    'DISPID_SPIEnginePrivateData', 'SPWF_SRENGINE', 'SPRULESTATE',
    'SAFT11kHz16BitMono', 'SVP_8', 'DISPID_SRRTTickCount',
    'SAFT32kHz16BitMono', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SGRSTPropertyValue', 'ISpAudio', 'eLEXTYPE_PRIVATE9',
    'DISPID_SRRAudio', 'DISPID_SRCVoicePurgeEvent', 'DISPID_SRGId',
    'SPINTERFERENCE_NONE', 'DISPID_SRGState',
    'DISPID_SRCSetAdaptationData', 'DISPID_SOTCategory',
    'SPLO_DYNAMIC', 'DISPID_SASCurrentDevicePosition',
    'SpPhoneConverter', 'SPSERIALIZEDRESULT', 'SpeechVoiceSpeakFlags',
    'SpAudioFormat', 'SPDKL_CurrentConfig', 'SGDisplay',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPPS_Interjection',
    'DISPID_SDKDeleteValue', 'SP_VISEME_13', 'SPAUDIOSTATE',
    'DISPID_SRProfile', 'SpWaveFormatEx', 'DISPID_SRGRecoContext',
    'DISPID_SVDisplayUI', 'DISPID_SpeechMMSysAudio',
    'DISPID_SGRSTWeight', 'SpTextSelectionInformation',
    'DISPID_SDKOpenKey', 'SpeechTokenKeyUI', 'DISPID_SOTCSetId',
    'eLEXTYPE_PRIVATE5', 'SPEI_START_INPUT_STREAM',
    'ISpeechWaveFormatEx', 'SPWORD', 'SAFT16kHz8BitMono',
    'DISPID_SWFEBlockAlign', 'DISPID_SPRules_NewEnum',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SPPChildren', 'eWORDTYPE_ADDED',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SVEEndInputStream',
    'DISPID_SWFEFormatTag', 'SSFMCreate', 'DISPID_SRCEAdaptation',
    'SVF_Stressed', 'SINoSignal', 'SPDKL_DefaultLocation',
    'SREAudioLevel', 'DISPID_SRRRecoContext', 'DISPID_SAStatus',
    'SAFT8kHz8BitMono', 'SREAllEvents',
    'SpeechRegistryLocalMachineRoot', 'Speech_StreamPos_Asap',
    'SP_VISEME_16', 'SAFT44kHz8BitStereo', 'ISpeechCustomStream',
    'DISPID_SGRInitialState', 'SPPS_Function', 'SVP_4', 'SPRS_ACTIVE',
    'SAFT48kHz16BitMono', 'DISPID_SVEPhoneme',
    ...
    'SREStreamStart', 'SAFTDefault', 'DISPID_SLPsItem',
    'SAFT32kHz16BitStereo', 'SAFTExtendedAudioFormat',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SVGetAudioOutputs',
    'SpeechPropertyResponseSpeed', 'DISPID_SPIStartTime',
    'SPVPRI_OVER', 'DISPID_SGRs_NewEnum', 'SVF_None',
    'DISPID_SRSetPropertyString', 'DISPID_SRGSetTextSelection',
    'DISPID_SVSCurrentStreamNumber', 'SGRSTTWildcard',
    'DISPID_SRGDictationUnload', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SVEStreamEnd', 'DISPID_SPILanguageId',
    'DISPID_SpeechObjectTokens', 'SPRST_INACTIVE', 'SVPOver',
    'DISPID_SLPs_NewEnum', 'WAVEFORMATEX', 'ISpeechAudio',
    'ISpeechRecoGrammar', 'SVP_7', 'SP_VISEME_12',
    'SAFTCCITT_uLaw_11kHzStereo', 'SPEI_REQUEST_UI',
    'eLEXTYPE_PRIVATE2', 'SGRSTTWord', 'DISPID_SPAsCount',
    'ISpeechPhraseAlternates', 'ISpDataKey', 'DISPID_SRIsUISupported',
    'DISPID_SABIMinNotification', 'DISPID_SpeechRecoResult2',
    'SPEI_RESERVED6', 'STCInprocHandler', 'SECFEmulateResult',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SVIsUISupported',
    'eLEXTYPE_PRIVATE16', 'SPEI_END_INPUT_STREAM', 'SPEI_HYPOTHESIS',
    'SpeechDiscardType', 'SSFMCreateForWrite', 'SPCONTEXTSTATE',
    'ISpeechGrammarRule', 'DISPID_SRCRetainedAudio',
    'DISPID_SPRulesCount', 'SFTInput', 'DISPID_SRRTStreamTime',
    'SPPROPERTYINFO', 'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SVP_2',
    'SVEVoiceChange', 'DISPID_SPPEngineConfidence',
    'SAFTADPCM_44kHzStereo', 'SPINTERFERENCE_NOISE',
    'SPEVENTSOURCEINFO', 'SPRECOCONTEXTSTATUS', 'SVEPhoneme',
    'DISPID_SPPConfidence', 'DISPID_SABIEventBias', 'SDKLCurrentUser',
    'DISPID_SBSFormat', 'eLEXTYPE_PRIVATE18', 'SPBO_PAUSE',
    'SAFTCCITT_uLaw_11kHzMono', 'SBONone', 'SVSFParseMask',
    'DISPID_SPERetainedSizeBytes', 'SECNormalConfidence',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SVAudioOutputStream',
    'SpeechUserTraining', 'SP_VISEME_4',
    ...
    'DISPID_SMSADeviceId', 'SP_VISEME_8', 'SPGS_DISABLED',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SVVolume', 'SPAO_RETAIN_AUDIO',
    'SP_VISEME_7', 'DISPID_SPPId', 'SVP_11', 'DISPID_SVStatus',
    'SpeechCategoryAudioIn', 'DISPID_SPPsItem',
    'DISPID_SLAddPronunciation', 'SpeechCategoryRecognizers',
    'DISPID_SpeechPhraseProperty', 'DISPID_SRSetPropertyNumber',
    'SVSFParseSsml', 'DISPID_SpeechRecoContextEvents',
    'eLEXTYPE_PRIVATE17', 'ISpeechFileStream',
    'ISpeechPhraseProperty', '__MIDL_IWinTypes_0009',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SpeechPhraseElement', 'ISpRecoContext2', 'SPVPRIORITY',
    'SVEAudioLevel', 'SRTExtendableParse',
    'DISPID_SRCCreateResultFromMemory', 'SPSUnknown',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SREFalseRecognition',
    'ISpeechGrammarRuleStateTransitions', 'SAFT12kHz8BitStereo',
    'SpeechMicTraining', 'SWPUnknownWordPronounceable',
    'SP_VISEME_18', 'SAFTTrueSpeech_8kHz1BitMono', 'STCRemoteServer',
    'DISPID_SLWs_NewEnum', 'SECLowConfidence',
    'DISPID_SRSClsidEngine', 'DISPID_SPPName', 'ISpStreamFormat',
    'DISPID_SABIBufferSize', 'DISPID_SRRGetXMLResult', 'SP_VISEME_5',
    'DISPID_SpeechBaseStream', 'DISPID_SLPPartOfSpeech',
    'DISPID_SpeechVoiceStatus', 'DISPID_SLGetGenerationChange',
    'SPBINARYGRAMMAR', 'DISPID_SPRFirstElement', 'SRSActive',
    'SpMMAudioEnum', 'SPINTERFERENCE_NOSIGNAL', 'SAFT24kHz8BitMono',
    'SpeechVisemeType', 'DISPID_SGRSRule',
    'SpeechDictationTopicSpelling', 'DISPID_SPEsItem',
    'DISPID_SDKGetBinaryValue', 'DISPID_SGRSTNextState', 'ISpVoice',
    'SVEStartInputStream', 'SP_VISEME_11',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPINTERFERENCE_TOOSLOW',
    'SGSDisabled', 'DISPID_SPEEngineConfidence',
    'SAFT48kHz8BitStereo', 'DISPIDSPTSI_ActiveOffset',
    'SREPropertyStringChange', 'ISpObjectToken', 'SREAdaptation',
    'DISPID_SBSRead', 'SAFT24kHz8BitStereo', 'DISPID_SPCLangId',
    'SRAInterpreter', 'DISPID_SGRSTRule', 'ISequentialStream',
    'SECFIgnoreWidth', 'DISPID_SpeechRecoContext', 'DISPID_SRGRules',
    'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SPANumberOfElementsInResult', 'SPVISEMES',
    'DISPID_SpeechAudioStatus', 'ISpeechPhraseRules', 'SAFTText',
    'IStream', 'SRERequestUI', 'DISPID_SVSInputWordLength',
    'DISPID_SGRSAddRuleTransition', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SGRAddResource', 'SpeechGrammarWordType', 'ISpPhrase',
    'DISPID_SpeechAudio', 'SDA_Consume_Leading_Spaces',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SpeechRecognizer',
    'SAFT48kHz16BitStereo', 'ISpeechMMSysAudio', 'SPEI_PHRASE_START',
    'ISpeechPhoneConverter', 'SpeechFormatType', 'SBOPause',
    'SRAORetainAudio', 'SPVPRI_ALERT', 'SpCustomStream',
    'SPGRAMMARWORDTYPE', 'DISPID_SRRPhraseInfo', 'SITooQuiet',
    'DISPID_SPPValue', 'DISPID_SPERequiredConfidence',
    'SVEWordBoundary', 'DISPID_SCSBaseStream',
    'SpeechCategoryAudioOut', 'SAFT12kHz16BitMono',
    'ISpeechVoiceStatus', 'SpLexicon', 'eLEXTYPE_PRIVATE8',
    'SVSFIsXML', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SLPsCount', 'STCAll', 'SITooFast', 'ISpeechBaseStream',
    'SpeechPropertyComplexResponseSpeed', 'SpeechAddRemoveWord',
    'SAFT44kHz8BitMono', 'eLEXTYPE_APP', 'SGRSTTTextBuffer',
    'DISPID_SVEEnginePrivate', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SpeechMemoryStream', 'eLEXTYPE_PRIVATE14',
    'DISPID_SRCPause', 'SAFTADPCM_11kHzStereo',
    'SpeechPropertyHighConfidenceThreshold',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SVEventInterests',
    'DISPID_SOTGetDescription', 'DISPID_SRCEInterference',
    'Speech_StreamPos_RealTime', 'DISPID_SRRGetXMLErrorInfo',
    'SVSFPurgeBeforeSpeak', 'DISPID_SGRClear', 'eLEXTYPE_PRIVATE10',
    'ISpeechTextSelectionInformation', 'SLTUser', 'SPPS_Modifier',
    'ISpRecognizer', 'DISPID_SRGCmdLoadFromMemory', 'DISPID_SOTSetId',
    'ISpeechPhraseAlternate', 'SPEI_PROPERTY_NUM_CHANGE',
    'SDA_One_Trailing_Space', 'SpeechCategoryVoices',
    'DISPID_SVPause', 'DISPID_SGRAttributes',
    'DISPID_SLWPronunciations', 'DISPID_SOTCGetDataKey', 'SREPrivate',
    'SSSPTRelativeToCurrentPosition', 'SPRULE', 'DISPID_SOTsCount',
    'SRSInactive', 'SPSEMANTICERRORINFO', 'DISPID_SPPParent',
    'SPCT_SUB_COMMAND', 'SpeechRetainedAudioOptions',
    'ISpeechXMLRecoResult', 'SPSModifier', 'SpeechRunState',
    'DISPID_SGRSTType', 'SRSEIsSpeaking',
    'DISPID_SRCEPropertyStringChange', 'UINT_PTR',
    'SPSTREAMFORMATTYPE', 'eLEXTYPE_PRIVATE3', 'SPEVENTENUM',
    'SREPhraseStart', 'DISPID_SVSInputSentencePosition',
    'eLEXTYPE_RESERVED8', 'SPAR_Low', 'SREStateChange',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SDKSetLongValue',
    'ISpeechRecoResultTimes', 'SP_VISEME_21', 'SPPHRASERULE',
    'SPAS_CLOSED', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SRCState', 'ISpeechObjectTokenCategory',
    'DISPID_SRCRequestedUIType', 'SAFT22kHz8BitStereo',
    'DISPID_SGRSAddSpecialTransition', 'SECFIgnoreKanaType',
    'DISPID_SPIElements', 'DISPID_SLGetPronunciations',
    'SGRSTTEpsilon', 'SASStop', 'eLEXTYPE_RESERVED10',
    'DISPID_SAFGuid', 'SGRSTTRule', 'eLEXTYPE_RESERVED9',
    'DISPID_SRCBookmark', 'SVSFIsNotXML', 'SPSInterjection',
    'DISPID_SGRId', 'SPEI_RECOGNITION', 'SECFDefault', 'SSTTWildcard',
    'ISpResourceManager', 'SWPKnownWordPronounceable',
    'SPPS_SuppressWord', 'DISPID_SRCEHypothesis',
    'DISPID_SPELexicalForm', 'SP_VISEME_10', 'SpeechGrammarState',
    'SPAR_Medium', 'STCInprocServer', 'SPWORDTYPE',
    'DISPID_SRCAudioInInterferenceStatus', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SGRsAdd', 'SPPS_RESERVED4', 'eLEXTYPE_USER',
    'SAFTCCITT_ALaw_8kHzMono', 'SPXRO_Alternates_SML',
    'SPINTERFERENCE', 'SAFTADPCM_44kHzMono', 'SpeechAllElements',
    'SSFMOpenForRead', '_RemotableHandle', 'SAFTGSM610_11kHzMono',
    'ISpNotifySource', 'SPFM_OPEN_READONLY', 'ISpeechAudioStatus',
    'SpeechInterference', 'ISpeechAudioFormat', 'DISPID_SRCVoice',
    'SAFT16kHz8BitStereo', 'SAFT44kHz16BitStereo',
    'SVSFParseAutodetect', 'SVP_16', 'SVEViseme',
    'DISPID_SGRsCommitAndSave', 'eLEXTYPE_PRIVATE13',
    'SPPS_Noncontent', 'DISPID_SAFType', 'SAFTADPCM_8kHzMono',
    'DISPID_SVSRunningState', 'DISPID_SRRAudioFormat', 'SPAR_Unknown',
    'ISpLexicon', 'SpUnCompressedLexicon', 'SVP_15',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SPRuleFirstElement',
    'ISpeechMemoryStream', 'eLEXTYPE_PRIVATE1', 'DISPID_SGRsCommit',
    'DISPID_SGRsItem', 'ISpeechRecognizer', 'DISPID_SRCERequestUI',
    'SPBO_AHEAD', 'DISPID_SGRsFindRule', 'SPDATAKEYLOCATION',
    ...
    'SPAUDIOSTATUS', 'SPEI_UNDEFINED', 'SPSNotOverriden',
    'SVEPrivate', 'SpeechRegistryUserRoot', 'DISPID_SPCPhoneToId',
    'SSSPTRelativeToEnd', 'DISPID_SRCESoundStart',
    'SAFT22kHz8BitMono', 'SPEI_SOUND_END', 'DISPID_SDKEnumKeys',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SRSEDone', 'DISPID_SGRAddState',
    'DISPID_SVPriority', 'Speech_Default_Weight',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SASNonBlockingIO', 'DISPID_SPEAudioSizeTime',
    'ISpeechPhraseInfo', 'DISPID_SPIReplacements',
    'SGDSActiveWithAutoPause', 'SAFTNoAssignedFormat',
    'DISPID_SRDisplayUI', 'DISPID_SRCERecognitionForOtherContext',
    'SDTLexicalForm', 'SPEI_MAX_TTS', 'SVP_5', 'DISPID_SOTCDefault',
    'SPPHRASEPROPERTY', 'SpeechEngineProperties',
    'DISPID_SpeechDataKey', 'SVP_12', 'DISPIDSPTSI_SelectionOffset',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SPAPhraseInfo',
    'SPPHRASEELEMENT', 'DISPID_SVGetAudioInputs', 'SPCT_SLEEP',
    'SpeechTokenIdUserLexicon', 'SPBOOKMARKOPTIONS',
    'SSSPTRelativeToStart', 'ISpeechPhraseReplacement',
    'SpeechLexiconType', 'DISPID_SVSLastBookmarkId',
    'DISPID_SpeechRecoResult', 'DISPID_SRGDictationLoad',
    'SpeechCategoryRecoProfiles', 'DISPID_SLWWord',
    'SpeechRecoContextState', 'SpResourceManager',
    'DISPID_SABufferInfo', 'SPRECORESULTTIMES',
    'SAFTCCITT_ALaw_8kHzStereo', 'SpeechWordPronounceable',
    'SRTSMLTimeout', 'DISPID_SVAudioOutput',
    'ISpeechRecognizerStatus', 'SPTEXTSELECTIONINFO',
    'DISPID_SPAsItem', 'SPRS_INACTIVE', 'SAFT8kHz16BitMono',
    'DISPID_SFSClose', 'DISPID_SVWaitUntilDone', 'SECHighConfidence',
    'SpeechDataKeyLocation', 'SAFT22kHz16BitStereo', 'SPPS_RESERVED1',
    'DISPID_SOTsItem', 'SpeechSpecialTransitionType',
    'SpPhraseInfoBuilder', 'SVSFIsFilename',
    'DISPID_SRCreateRecoContext', 'SAFTCCITT_uLaw_8kHzStereo',
    'STSF_LocalAppData', 'DISPID_SRGetRecognizers',
    'ISpeechLexiconWords', 'SVSFNLPSpeakPunc', 'SPAO_NONE',
    'DISPID_SPIEngineId', 'SRTEmulated', 'DISPID_SPARecoResult',
    'DISPID_SPEAudioTimeOffset', 'SpMMAudioOut',
    'SpeechAudioFormatGUIDWave', 'DISPID_SRCEAudioLevel',
    'SPEI_END_SR_STREAM', 'SPPHRASEREPLACEMENT', 'SpInprocRecognizer',
    'DISPID_SPCIdToPhone', 'SDA_No_Trailing_Space', 'SRTStandard',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SOTGetAttribute',
    'ISpeechGrammarRuleState', 'SAFTCCITT_ALaw_22kHzMono',
    'eLEXTYPE_VENDORLEXICON', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SMSGetData', 'SPWAVEFORMATTYPE',
    'DISPID_SWFEAvgBytesPerSec', 'SAFTADPCM_8kHzStereo',
    ...
    'DISPID_SVGetVoices', 'ISpPhraseAlt', 'SpMemoryStream',
    'DISPID_SPRuleEngineConfidence', 'eLEXTYPE_PRIVATE7',
    'DISPID_SRRTOffsetFromStart', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SPIAudioSizeBytes', 'eLEXTYPE_RESERVED4', 'SSTTDictation',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SpeechPhraseAlternates',
    'SAFTNonStandardFormat', 'DISPID_SPRuleConfidence',
    'DISPID_SRCEFalseRecognition', 'SpeechRecognitionType',
    'DISPID_SRCEEndStream', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SpeechAudioProperties', 'SPRST_NUM_STATES',
    'SpNullPhoneConverter', 'eLEXTYPE_MORPHOLOGY', 'SpFileStream',
    'SpShortcut', 'DISPID_SPIGetText', 'ISpRecoContext',
    'eLEXTYPE_PRIVATE20', 'SWPUnknownWordUnpronounceable',
    'SGDSActiveUserDelimited', 'SP_VISEME_20', 'SPFM_OPEN_READWRITE',
    'ISpPhoneConverter', 'SECFNoSpecialChars', 'eLEXTYPE_RESERVED7',
    'DISPID_SRSCurrentStreamNumber', 'SPWORDPRONOUNCEABLE',
    'SPINTERFERENCE_TOOFAST', 'ISpRecoResult', 'SINone',
    'ISpeechObjectTokens', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SWFEBitsPerSample', 'DISPID_SMSAMMHandle',
    'SPSHT_Unknown', 'DISPID_SOTIsUISupported', 'SLTApp',
    'SAFTCCITT_uLaw_22kHzMono', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SRAudioInput', 'DISPID_SRGetPropertyNumber',
    'SPCS_DISABLED', 'DISPID_SPRuleNumberOfElements', 'SPEI_PHONEME',
    'DISPID_SVSLastResult', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SRRTLength', 'SAFT8kHz16BitStereo', 'DISPID_SOTCId',
    'DISPID_SMSSetData', 'DISPID_SpeechLexiconWords',
    'SPSHT_NotOverriden', 'DISPID_SLGenerationId',
    'DISPID_SRRSaveToMemory', 'SpeechGrammarTagWildcard',
    'DISPID_SRRTimes', 'DISPID_SREmulateRecognition', 'ISpEventSink',
    'SPSHORTCUTPAIRLIST', 'DISPID_SpeechObjectToken', 'ISpMMSysAudio',
    'SPCS_ENABLED', 'SVP_9', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SRCEEnginePrivate', 'SPLEXICONTYPE', 'DISPID_SRGReset',
    'ISpeechAudioBufferInfo', 'ISpeechLexiconWord',
    'SPADAPTATIONRELEVANCE', 'SPLO_STATIC', 'SVF_Emphasis',
    'IInternetSecurityManager', 'SRARoot', 'SSFMOpenReadWrite',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SVResume',
    'DISPID_SPIRetainedSizeBytes', 'SLOStatic', 'SPXRO_SML',
    'IEnumString', 'SDTAll', 'SPDKL_CurrentUser', 'SPSHT_OTHER',
    'SPEI_INTERFERENCE', 'SGLexicalNoSpecialChars',
    'DISPID_SRCRetainedAudioFormat', 'SPEI_MAX_SR', 'SPVOICESTATUS',
    'DISPID_SPIGetDisplayAttributes', 'STSF_CommonAppData',
    'SPVPRI_NORMAL', 'DISPID_SpeechLexicon', 'SPSVerb',
    'SpeechAudioFormatType', 'DISPID_SGRSTsCount',
    'DISPID_SLGetWords', 'SASClosed', 'DISPID_SRGIsPronounceable',
    'DISPID_SLAddPronunciationByPhoneIds', 'SVSFUnusedFlags',
    'DISPID_SVSkip', 'SRAONone', 'SPPS_Noun',
    'DISPID_SpeechXMLRecoResult', 'SVSFlagsAsync', 'SRATopLevel',
    'ISpObjectWithToken', 'DISPID_SGRSAddWordTransition',
    'DISPID_SADefaultFormat', 'DISPIDSPRG',
    'DISPID_SWFESamplesPerSec', 'ISpeechDataKey', 'SVP_14',
    '_SPAUDIOSTATE', 'DISPID_SpeechAudioFormat',
    'DISPID_SRCRecognizer', 'ISpPhoneticAlphabetSelection', 'SPEVENT',
    'SVP_20', 'SREBookmark', 'SVPAlert', 'DISPID_SpeechPhraseInfo',
    'ISpStreamFormatConverter', 'SpeechEngineConfidence',
    'SpeechAudioState', 'SpeechWordType', 'SRADefaultToActive',
    'DISPID_SpeechWaveFormatEx', 'ISpeechPhraseProperties',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SVEVoiceChange',
    'DISPID_SpeechPhraseElements', 'SPFILEMODE', 'DISPID_SLWsCount',
    'DISPID_SVSpeakStream', 'SPEI_TTS_BOOKMARK',
    ...
    'SpeechTokenContext', 'DISPID_SpeechObjectTokenCategory',
    'SPAS_STOP', 'SVP_1', 'SpeechPropertyResourceUsage',
    'DISPID_SOTs_NewEnum', 'ISpRecognizer2', 'SPSMF_UPS',
    'DISPID_SRCEBookmark', 'SREHypothesis', 'SPDKL_LocalMachine',
    'SPEI_RESERVED3', 'DISPID_SpeechPhraseReplacement',
    'SPEI_SOUND_START', 'IEnumSpObjectTokens', 'DISPID_SLPLangId',
    'DISPID_SPRuleId', 'SRTAutopause',
    'DISPID_SVSInputSentenceLength', 'tagSPPROPERTYINFO',
    'SPRST_INACTIVE_WITH_PURGE', 'ISpSerializeState',
    'SDKLLocalMachine'
]
